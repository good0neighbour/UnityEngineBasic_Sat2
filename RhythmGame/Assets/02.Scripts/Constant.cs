...
{
    public const float HIT_JUDGE_RANGE_BAD = 5.0f;
    public const float HIT_JUDGE_RANGE_MISS = 2.5f;
    public const float HIT_JUDGE_RANGE_GOOD = 1.0f;
    public const float HIT_JUDGE_RANGE_GREAT = 0.5f;
    public const float HIT_JUDGE_RANGE_COOL = 0.2f;
